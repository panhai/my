            ...
            <div class="questionBottom">
                ...
                <div class="questionMain">
                    ...
                    <ul class="selectUl judgeBtn" v-if="currentItemType=='JUDGEMENT'">
                        <button @click.prevent="chooseOption($event)" value="true" :class="answer.length>0&&answer.indexOf('true')!=-1 ? 'blue' : ''">√</button>
                        <button @click.prevent="chooseOption($event)" value="false" :class="answer.length>0&&answer.indexOf('false')!=-1 ? 'blue' : ''">×</button>
                    </ul>
