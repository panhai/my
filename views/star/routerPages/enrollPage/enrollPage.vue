                    ...
                    <van-row>
                        ...
                        <van-col offset="1" span="18">
                            <div>
                                ...
                                <div class="text"> {{location.grandpaName}} &nbsp;{{location.parentName}} &nbsp;{{location.areaName}} </div>
                            </div>
                        </van-col>
                    </van-row>
                </van-col>
...
<script>
    ...
    import { getLoginInfo, getStoreStudent, setStoreStudent, getStudentIndex} from '../../../../js/user.js';
    import { removeStore} from '../../../../js/common.js';
    import { getByUser, listByCity ,getParent, putStudent, putPerson, applicantPost, getPerson2, postStudent, getPerson,postPerson, postAssociate } from '../../../../service/api.js';
    import { } from '../../../../service/api.js'

    import { getGroup, } from '../../../../service/star/api.js'
