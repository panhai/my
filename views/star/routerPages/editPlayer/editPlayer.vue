    ...
    <div class="playerEdit" v-wechat-title="this.navTitle">
        ...
        <div class="pageContent">
            ...
            <div v-if="pageType == 'evpi'" class="btnContent">
                <control-btn :btnActive="true" btnText="完成" class="submitBtn" @click.native.prevent="verifyForm"></control-btn>
            </div>
...
<script>
    ...
    import { getLoginInfo, setStoreStudent , getStoreStudent, setStudentIndex, getStudentIndex } from '../../../../js/user.js';
    ...
    export default {
        ...
        methods:{
            ...
            async getStudent(id){
                ...
                this.formList.urgentPerson=this.student.person.urgentPerson;
                this.formList.urgentPhoneNumber=this.student.person.urgentPhoneNumber;
