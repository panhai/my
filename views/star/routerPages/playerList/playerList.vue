        ...
        <div class="containerInner">
            ...
            <div class="personContent">
                ...
                <div class="studentList" v-if="studentList.length>0">
                    <div class="personItem"  v-for="(studentItem,index) in studentList" :key="index" @click="goToEditPlayer(index)">
...
<script>
    ...
    import { getLoginInfo,setStoreStudent } from '../../../../js/user.js'
        ...
        methods:{
            ...
            goToEditPlayer(index){
                ...
                if(index != undefined && index != null){
                    this.$router.push({ path:'/editPlayer',query:{student:this.studentList[index].identifier,type:'star'}})
                }else{
