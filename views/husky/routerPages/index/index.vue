...
<script>
    import { getLoginInfo, getToken } from '../../../../js/user.js';
    import { getStore, setStore, clearStore, clearSession} from '../../../../js/common.js';
    import { getByUser, listByStudent, getMatch, getNum, getPlayer, getPerson } from '../../../../service/api.js';
